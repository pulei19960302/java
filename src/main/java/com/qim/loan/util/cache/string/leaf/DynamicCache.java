 ...
 */
@Service("dynamicCache")
public class DynamicCache  extends BaseStringCache{

	@Override
	protected int getTime() {//秒
		return CacheSetting.getDynamicSetting().getTime();//(24*3600)
	}
	@Override
	protected int getDB() {//0号
		return CacheSetting.getDynamicSetting().getLibrary();
	}
